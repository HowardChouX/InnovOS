...
function parseReport(output: unknown): Report | null {
  ...
  if (typeof output === 'object' && output !== null && 'title' in output) return output as Report;
  return null;
}

export function CompletedView({ output }: { output: unknown }) {
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        <i
          ...
          style={{ fontSize: 20, color: 'var(--accent-green)' }}
        />
      ...
      {report.summary && (
        ...
        >
          <div
            style={{ fontSize: 12, fontWeight: 600, color: 'var(--accent-green)', marginBottom: 6 }}
          >
      ...
      {report.topSolutions && report.topSolutions.length > 0 && (
        ...
        >
          <div
            style={{ fontSize: 12, fontWeight: 600, color: 'var(--accent-blue)', marginBottom: 6 }}
          >
