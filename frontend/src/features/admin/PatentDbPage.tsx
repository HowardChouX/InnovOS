...
export function PatentDbPage() {
  ...
  const save = async () => {
    try {
      if (editing) {
        await api(`/api/admin/patents/${editing.id}`, {
          method: 'PUT',
  ...
  const handleUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      setToast({ msg: '上传失败: ' + msg, type: 'error' });
    }
    setUploading(false);
        ...
        {patents.length === 0 ? (
          ...
          >
            <i
              ...
              style={{ fontSize: 28, marginBottom: 10, opacity: 0.3, display: 'block' }}
            />
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12 }}>
            ...
            <tbody>
              {patents.map((p) => (
                ...
                >
                  <td
                    style={{ padding: '10px 12px', color: 'var(--text-primary)', fontWeight: 500 }}
                  >
                    {p.title}
                  </td>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
          ...
          <button
            ...
            style={{
              ...
              background: 'var(--bg-card)',
              color: 'var(--text-secondary)',
              cursor: page < pageTotal ? 'pointer' : 'default',
              fontFamily: 'inherit',
            }}
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                <FormField label="公开（公告）号">
                  <input
                    ...
                    onChange={(e) => setForm((f) => ({ ...f, publicationNumber: e.target.value }))}
                    style={inputStyle}
                    placeholder="CN122158040A"
                  />
                </FormField>
              ...
              <FormField label="IPC分类号">
                <input
                  ...
                  style={inputStyle}
                  placeholder="G06F17/30; G06F16/00"
                />
              </FormField>
