...
export function Toolbar({ editor, formattingState, onCommand, scrollContainer }: ToolbarProps) {
  ...
  function getFormattingState(state: FormattingState, command: FormattingCommand): boolean {
    switch (command) {
      ...
      case 'heading1':
        return state.isHeading1;
      case 'heading2':
        return state.isHeading2;
      case 'heading3':
        return state.isHeading3;
      case 'heading4':
        return state.isHeading4;
      case 'heading5':
        return state.isHeading5;
      case 'heading6':
        return state.isHeading6;
      case 'bulletList':
        return state.isBulletList;
      case 'orderedList':
        return state.isOrderedList;
      case 'codeBlock':
        return state.isCodeBlock;
      case 'blockquote':
